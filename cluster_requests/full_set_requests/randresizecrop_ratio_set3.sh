#!/bin/bash
#SBATCH --job-name=randresizecrop_ratio_set3
#SBATCH --output=out_randresizecrop_ratio_set3.log
#SBATCH --gres=gpu:1
#SBATCH --ntasks=1
...
python /home/clo37/priv/VLM-MIA-Study/mia.py \
    path.output_dir=/local/scratch/clo37/VLM_MIA_STUDY_Archive_Data/LatestResults/full_results/randresizecrop_ratio_set3 \
...
\
    ...
    data.augmentations.RandomResize.ratio='[[1.67,1.67],[1.80,1.80],[2.0,2.0],[2.5,2.5],[3.0,3.0],[4.0,4.0],[5.0,5.0],[6.0,6.0]]' \
