#!/bin/bash
#SBATCH --job-name=randrotate_set1
#SBATCH --output=out_randrotate_set1.log
#SBATCH --gres=gpu:1
#SBATCH --ntasks=1
...
python /home/clo37/priv/VLM-MIA-Study/mia.py \
    path.output_dir=/local/scratch/clo37/VLM_MIA_STUDY_Archive_Data/LatestResults/full_results/randrotate_set1 \
...
\
    ...
    data.augmentations.RandomRotation.degrees='[0.01,0.05,0.1,0.25,0.5,0.75,1.0,2.0]' \
