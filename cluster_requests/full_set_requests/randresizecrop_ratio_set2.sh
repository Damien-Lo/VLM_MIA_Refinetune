#!/bin/bash
#SBATCH --job-name=randresizecrop_ratio_set2
#SBATCH --output=out_randresizecrop_ratio_set2.log
#SBATCH --gres=gpu:1
#SBATCH --ntasks=1
...
python /home/clo37/priv/VLM-MIA-Study/mia.py \
    path.output_dir=/local/scratch/clo37/VLM_MIA_STUDY_Archive_Data/LatestResults/full_results/randresizecrop_ratio_set2 \
...
\
    ...
    data.augmentations.RandomResize.ratio='[[0.6,0.6],[0.667,0.667],[0.75,0.75],[0.833,0.833],[1.0,1.0],[1.2,1.2],[1.33,1.33],[1.50,1.50]]' \
