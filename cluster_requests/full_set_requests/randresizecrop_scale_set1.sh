#!/bin/bash
#SBATCH --job-name=randresizecrop_scale_set1
#SBATCH --output=out_randresizecrop_scale_set1.log
#SBATCH --gres=gpu:1
#SBATCH --ntasks=1
...
python /home/clo37/priv/VLM-MIA-Study/mia.py \
    path.output_dir=/local/scratch/clo37/VLM_MIA_STUDY_Archive_Data/LatestResults/full_results/randresizecrop_scale_set1 \
...
\
    ...
    data.augmentations.RandomResize.scale='[[0.001,0.001],[0.0025,0.0025],[0.005,0.005],[0.0075,0.0075],[0.01,0.01],[0.025,0.025],[0.05,0.05],[0.075,0.075]]' \
