#!/bin/bash
#SBATCH --job-name=randrotate_set2
#SBATCH --output=out_randrotate_set2.log
#SBATCH --gres=gpu:1
#SBATCH --ntasks=1
...
python /home/clo37/priv/VLM-MIA-Study/mia.py \
    path.output_dir=/local/scratch/clo37/VLM_MIA_STUDY_Archive_Data/LatestResults/full_results/randrotate_set2 \
...
\
    ...
    data.augmentations.RandomRotation.degrees='[3.0,5.0,7.5,10.0,15.0,20.0,30.0,40.0]' \
