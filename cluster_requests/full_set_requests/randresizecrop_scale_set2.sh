#!/bin/bash
#SBATCH --job-name=randresizecrop_scale_set2
#SBATCH --output=out_randresizecrop_scale_set2.log
#SBATCH --gres=gpu:1
#SBATCH --ntasks=1
...
python /home/clo37/priv/VLM-MIA-Study/mia.py \
    path.output_dir=/local/scratch/clo37/VLM_MIA_STUDY_Archive_Data/LatestResults/full_results/randresizecrop_scale_set2 \
...
\
    ...
    data.augmentations.RandomResize.scale='[[0.1,0.1],[0.2,0.2],[0.3,0.3],[0.4,0.4],[0.5,0.5],[0.6,0.6],[0.7,0.7],[0.8,0.8]]' \
