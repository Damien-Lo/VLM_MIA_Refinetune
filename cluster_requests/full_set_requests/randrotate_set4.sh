#!/bin/bash
#SBATCH --job-name=randrotate_set4
#SBATCH --output=out_randrotate_set4.log
#SBATCH --gres=gpu:1
#SBATCH --ntasks=1
...
python /home/clo37/priv/VLM-MIA-Study/mia.py \
    path.output_dir=/local/scratch/clo37/VLM_MIA_STUDY_Archive_Data/LatestResults/full_results/randrotate_set4 \
...
\
    ...
    data.augmentations.RandomRotation.degrees='[165.0,170.0,175.0,177.5,179.0,179.5,180.0]' \
